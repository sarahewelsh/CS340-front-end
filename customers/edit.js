		...
		editreq.onreadystatechange = function () {
			...
			if (this.readyState === XMLHttpRequest.DONE && this.status === 200) {
				...
				window.location.href =
					"http://web.engr.oregonstate.edu/~welshsa/public/customers";
			}
		};
...
document.addEventListener("DOMContentLoaded", getSpecificCustomer(id));
function getSpecificCustomer(id) {
	...
	req.open(
		"GET",
		"http://flip1.engr.oregonstate.edu:8687/customers/" + id,
		true
	);
